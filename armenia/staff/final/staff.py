    ...
    try:
        ...
        for div in range (1, 51):
            try:
                ...
                # Logo
                try:
                    logo = Selector(response=page).xpath(f'//*[@id="w0"]/div[{div}]/div/div/a[1]/div[1]/picture/source/@srcset').get()
                except:
                    logo = ""
                ...
                addresses = { "location" : { "country" : "AM", "city" : location_id[0] }, "postal_code" : "", "appartament" : address }
