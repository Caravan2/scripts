...
for i in range(3000, 140000):
    try:
        ...
        if status != "Operating":
            ...
            possibilities1 = ["str.", "Str.", "Ave.", "ave.", "ln.", "Ln.", "Plateau", "settlement", "mass.", "sq.", "Sq.", "In.", "In ", "Highway", "Alley", "cul-de-sac", "(Temka)", "Plot.", "Range", "Ascent", "Embankment", "Q.", "Dead-end", "Descent", "city", "Khevi", "passage", "Sector", "Lane", "m/d", "cul-de-ac", "str", "Plot", "Mount", "square", "zone"]
            possibilities2 = ["Vazha-Pshavela", "Varketili", "Vazisubani", "Sanzona", "A. Ghoghoberidze", "Village Dighomi", "Tskneti", "Avchala",]
